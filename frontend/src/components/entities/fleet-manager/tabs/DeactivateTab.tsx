          ...
          {isLoading && vehicles.length === 0 ? (
            ...
            <div className="w-full space-y-4">
              <div className="flex justify-between items-center gap-4">
                ...
                <Button onClick={loadVehicles} loading={isLoading} variant="outline" size="sm">
                  <IconRefresh size={16} />
                  Refresh
                </Button>
              </div>
              ...
              <div className="rounded-lg border bg-white p-6 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      {visibleSelectedVehicles.length === filteredVehicles.length && filteredVehicles.length > 0
                        ? 'Deselect All'
                        : 'Select All'}
                    </button>
                  </div>
                  ...
                  {selectedVehicles.length > 0 && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4 space-y-4">
                      <p className="text-sm text-yellow-800">
                        ...
                        <span className="font-semibold">{visibleSelectedVehicles.length}</span>{' '}
                        vehicle(s)
                        {selectedVehicles.length !== visibleSelectedVehicles.length && (
                          <span className="text-xs text-gray-500 ml-1">
                            (+{selectedVehicles.length - visibleSelectedVehicles.length} hidden)
                          </span>
                        )}
                      </p>
