...
import DataCard from '@/components/kpis/DataCard';
import React from 'react';
import { SelectedFilter } from '@/interfaces/common/optionSelector/DataFilter';
import DataCardGetIcon from '@/components/kpis/DataCardGetIcon';
import { formatNumber, getPercentageVariation } from '@/lib/dataDisplay';
