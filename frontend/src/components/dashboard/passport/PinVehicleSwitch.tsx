...
const PinVehicleSwitch: React.FC<PinVehicleSwitchProps> = ({
  ...
  <div className="flex justify-between items-center select-none">
    ...
    <label className="flex items-center cursor-pointer select-none relative">
      ...
      <div className="absolute left-1 top-1 bg-white w-4 h-4 rounded-full shadow border border-gray/30 peer-checked:border-primary peer-checked:translate-x-5 transition-all"></div>
    </label>
  </div>
);
