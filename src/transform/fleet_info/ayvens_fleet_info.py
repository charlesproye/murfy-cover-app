...
def get_fleet_info(bucket=S3_Bucket()) -> DF:
    ...
    return (
        ...
        .merge(fleet_info_with_only_start_date, left_on="vin", right_on="VIN", how="left")
        .rename(columns={"Car registration date": "registration_date", "Contract start date": "contract_start_date"})
        .merge(fleet_info_with_contract_start_date, left_on="vin", right_on="VIN", how="left")
        .rename(columns={"Contract start datum": "contract_start_date"})
