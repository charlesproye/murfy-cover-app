...
SCHEMAS = {
    "mercedes-benz": StructType([
                    ...
                    StructField("charging_session", StructType([
                        ...
                        StructField("displayed_start_state_of_charge", ArrayType(StructType([
                            StructField("timestamp", TimestampType()),
                            StructField("failure", StringType()),
                            StructField("data", TimestampType())
                        ]))),
                        StructField("displayed_state_of_charge", ArrayType(StructType([
                            StructField("timestamp", TimestampType()),
                            StructField("failure", StringType()),
                            StructField("data", TimestampType())
                        ]))),
                        StructField("end_time", ArrayType(StructType([
                            StructField("timestamp", TimestampType()),
                            StructField("failure", StringType()),
                            StructField("data", TimestampType())
                        ]))),
                        StructField("energy_charged", ArrayType(StructType([
                            StructField("timestamp", TimestampType()),
                            StructField("failure", StringType()),
                            StructField("data", StructType([
                                StructField("unit", StringType()),
                        ...
                        StructField("total_charging_duration", ArrayType(StructType([
                            StructField("timestamp", TimestampType()),
                            StructField("failure", StringType()),
                            StructField("data", StructType([
                                StructField("unit", StringType()),
