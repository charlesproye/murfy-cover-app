"""adding active trendline

Revision ID: 62cd0bf4aad1
Revises: 152343715635
Create Date: 2025-05-14 11:02:13.224627
...
revision = "62cd0bf4aad1"
down_revision = "152343715635"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column(
        "vehicle_model", sa.Column("trendline_active", sa.Boolean(), nullable=True)
    )
